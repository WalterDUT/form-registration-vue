          ...
          <div class="field is-narrow">
            <div class="control">
              <div
                ...
                :class="{ 'is-danger': $v.country.$error }"
              >
        ...
        <div class="field-body">
          <div class="field">
            <div class="control">
              <input
                v-model="passConfirm"
                :class="{ 'is-danger': $v.passConfirm.$error }"
                class="input"
                type="password"
                placeholder="Password"
              />
            ...
            <!-- error paragraph after this -->
            <p
              v-if="$v.passConfirm.$dirty && !$v.passConfirm.required"
              class="help is-danger"
            >
              This field is required.
            </p>
            <p
              v-if="$v.passConfirm.$dirty && !$v.passConfirm.sameAsPass"
              class="help is-danger"
            >
            ...
            <div class="control">
              <label class="radio">
                <input
                  type="checkbox"
                  v-model="consent"
                  :class="{ 'is-danger': $v.consent.$error }"
                />
              ...
              <!-- error paragraph after this -->
              <p
                v-if="$v.consent.$dirty && !$v.consent.mustBeTrue"
                class="help is-danger"
              >
